...
const Profile = () => {
    return (
        <section id="profile" className="min-h-[90vh] flex flex-col items-center justify-center text-center py-20 animate-fade-in-up">
            ...
            <h1 className="text-6xl sm:text-8xl font-normal text-neutral-900 dark:text-white mb-6 tracking-tight transition-colors duration-300" style={{ fontFamily: "'Gentium Book Plus', serif" }}>
                Akshay
            </h1>
