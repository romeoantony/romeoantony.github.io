...
const ProjectCard = ({ project }) => {
    const { title, description, staticImage, gifImage, tags, demoLink, repoLink } = project;
    return (
        <div className="project-card">
            <img className="project-image" src={staticImage} alt={title} />
            <div className="project-content">
                <div className="project-buttons">
                    {repoLink && (
                        <a href={repoLink} target="_blank" rel="noopener noreferrer" className="project-button github-icon-link" aria-label="GitHub Repo">
                    ...
                    {demoLink && (
                        <a href={demoLink} target="_blank" rel="noopener noreferrer" className="project-button" aria-label="Live Demo">
